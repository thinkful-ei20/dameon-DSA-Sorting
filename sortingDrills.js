...
let qSortArray = [ 89, 30, 25, 32, 72, 70];
  //  42, 25, 24 ,53 ,55, 78, 50, 13, 40, 48, 32, 26, 2, 14,
...
function quickSort(array, start=0, end=array.length, count=0) {
  ...
  array = quickSort(array, start, middle, count);
  array = quickSort(array, middle + 1, end, count);
  return array;
}
